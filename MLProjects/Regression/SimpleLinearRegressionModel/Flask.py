...
app = Flask(__name__)
model = joblib.load(r"C:\Users\roshn\OneDrive\Documents\GitHub\DataScience\MLProjects\Regression\SimpleLinearRegressionModel\student_marks_predictor_model.pkl")
